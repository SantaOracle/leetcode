package org.github.learning.leetcode.data.structure;
 ...
 * 跳表
 *
 * @author jiangpeiheng create on 2019/12/2
 */
public class SkipList<T> {
    ...
    private void backLink(SkipListNode<T> node1, SkipListNode<T> node2) {
        ...
        if (node1.right != null) node1.right.left = node2;
        node1.right = node2;
    }
    ...
    private void horizontalLink(SkipListNode<T> node1, SkipListNode<T> node2) {
        if (node1 != null) node1.right = node2;
        if (node2 != null) node2.left = node1;
    }
    ...
    private void vertiacallLink(SkipListNode<T> node1, SkipListNode<T> node2) {
        if (node1 != null) node1.down = node2;
        if (node2 != null) node2.up = node1;
    }
